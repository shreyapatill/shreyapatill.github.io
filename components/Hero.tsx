            ...
            <div className="max-h-[300px] md:max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
              <p className="text-neutral-700 dark:text-neutral-300 text-sm leading-relaxed space-y-4">
                <span className="block">
                  Hi! I'm Shreya, a student pursuing my degree in Electrical and Computer Engineering 
                  with a passion for making an impact on the world using technology 🌎💻. I'm interested 
                  in many areas of tech, but artificial intelligence, data engineering, and embedded 
                  systems interest me the most!
                </span>
                
                <span className="block">
                  I've completed internships at Amazon Lab 126, Amazon, and John Deere, as well as worked 
                  on my own startups to practically apply my engineering skills, which you can learn about 
                  below ⬇️. On campus, I've been very active, including participating & mentoring in women in engineering 
                  organizations, holding various leadership positions, taking part in sustainability 
                  initiatives, projects, and councils, and working on social impact entrepreneurial projects ❤️🌍.
                </span>
                
                <span className="block">
                  Apart from ECE and CS courses, I pride myself in taking interdisciplinary coursework, 
                  specifically related to sustainability/energy/environment and industrial design. When 
                  I'm not coding or building things, you can find me practicing yoga, cooking, painting, or tasting new pizza slices 🍕. 
                  I'm very adventurous and love to travel and try new things 🪂🏄‍♀️. I am always looking to connect 
                  with people with similar interests, so feel free to reach out! 💬🤗
                </span>
              </p>
            </div>
          </div>
